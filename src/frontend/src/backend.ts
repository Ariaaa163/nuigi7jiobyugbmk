...
import type { RegistrationId as _RegistrationId, SubmitResult as _SubmitResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitRegistration(arg0: RegistrationInput): Promise<SubmitResult> {
        if (this.processError) {
            try {
